...
export const userPageShell =
  "mx-auto w-full max-w-lg md:max-w-3xl lg:max-w-5xl min-h-[80vh] pb-24 md:pb-10 space-y-4 md:space-y-6 px-0 md:px-2 min-w-0";
...
export const userHeaderActionBtn = "h-8 shrink-0 gap-1 px-2 text-xs sm:px-3";
