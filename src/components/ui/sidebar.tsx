...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      const writeCookie = (next: boolean) => {
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn(
          "flex h-svh shrink-0 w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground",
          className,
        )}
        ref={ref}
        {...props}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          style={
            {
              "--sidebar-width": "var(--sb-width-mobile, 18rem)",
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative h-svh shrink-0 bg-transparent sidebar-layout-gap",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh border-sidebar-border md:flex sidebar-panel-shell",
          side === "left" ? "left-0 border-r" : "right-0 border-l",
          state === "expanded" && "w-[--sidebar-width]",
          state === "collapsed" &&
            collapsible === "offcanvas" &&
            (side === "left" ? "-translate-x-full w-[--sidebar-width]" : "translate-x-full w-[--sidebar-width]"),
          state === "collapsed" &&
            collapsible === "icon" &&
            (variant === "floating" || variant === "inset"
  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        isCollapsed && "size-8! p-2! [&>span:last-child]:hidden",
        className,
      )}
      {...props}
    />
